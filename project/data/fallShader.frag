...
void main() {
	...
	tx1.x += 2.0*sin(tx1.x * 20.0 + offset)/15.0;
	tx1.y -= 2.0*(0.03*offset + sin(tx1.y * 50.0 + offset) / 250.0);

	tx2.x += 2.0*sin(tx2.x * 20.0 + offset)/15;
	tx2.y -= 4.0*(0.03*offset + sin(tx2.y * 50.0 + offset) / 250.0);

	tx3.x += 2.0*sin(tx3.x * 20.0 + offset)/15;
	...
	c1 = vec4(vec3(c1) * 6.0, ac1*1.01);
	c2 = vec4(vec3(c2) * 6.0, ac2*1.01);
	c3 = vec4(vec3(c3) * 6.0, ac3*1.01);
